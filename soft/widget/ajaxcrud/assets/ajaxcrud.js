...
$(document).ready(function () {
    ...
    $(document).on('click', '[role="modal-remote-bulk"]', function (event) {
        ...
        if (selectedIds.length == 0) {
            ...
            modal.show();
            modal.setTitle('Birorta ham element tanlanmadi!');
            modal.setContent("Ushbu amalni bajarish uchun kamida bitta elementni tanlashingiz kerak!");
            modal.addFooterButton("Yopish", null,'btn btn-default', function (button, event) {
                this.hide();
            });
        } else {
            // Open modal
